...
2. **重排** 只在这 80 只里算换手 L1 和筹码 EMD，分位加权。分位的分母是召回池，不是 5000 只。默认 **筹 0.65 / 量 0.35**（决策 23）。
...
窗口 2026-02-25 → 2026-08-26，126 根，模板 `sh.600869`，对照 `sz.300806`。

| 指标 | 斯迪克 | 在召回 80 里 |
|------|--------|----------------|
| 收盘 DTW | 5.16 | K 线约第 55（前 20 门槛 4.45） |
| 收盘相关 | 0.885 | 相关全市场约第 67 |
| 换手 L1 | 0.206 | 50/79 只比它更好（偏弱） |
| 筹码 EMD | 0.045 | 13/79 更好（前 16%） |

精排名次：量 60/筹 40 → **35**；量 40/筹 60 → **20**；量 30/筹 70 → **18**。默认改为筹 0.65 / 量 0.35，显示 40，这只会进表。看板「精排偏好」：偏筹码 35/65（默认）、均衡 50/50、偏换手 70/30。
