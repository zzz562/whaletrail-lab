...
召回–重排（`0109bca`，紫金 90 日，召回 80）：**3.66s**。中金黄金仍第 1（召回第 2，Δ=0）。山金国际召回 4 → 排序 8。茅台/中石油仍在 80 池内（召回 69/74，K DTW≈6.0），重排抬到 2/3，Δ=+65/+71——门没关在全市场，关在「K 线前 80」。要把它们挤出去，把召回池收到 ~40。
